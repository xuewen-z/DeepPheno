...
[STAT16YPHN,R]=geotiffread(['../output/17_TAVG12IND/Cnn12NSE.',YPHNName,'.2001.2015.tif']);
Class=STAT16YPHN;
Class(Class<0)=0;
...
text('String',['a)',' NSE (',CaptName,')'],'Units','Normalized','Position',[0.02 0.20],'FontWeight','bold','Fontname','Times New Roman','Fontsize',34);
text('String','1D-CNNR vs. MODIS','Units','Normalized','Position',[0.02 0.10],'FontWeight','bold','Fontname','Times New Roman','Fontsize',34);
...
[STAT16YPHN,R]=geotiffread(['../output/17_TAVG12IND/Cnn12RMSE.',YPHNName,'.2001.2015.tif']);
Class=STAT16YPHN;
...
text('String',['b)',' RMSE (',CaptName,')'],'Units','Normalized','Position',[0.02 0.20],'FontWeight','bold','Fontname','Times New Roman','Fontsize',34);
text('String','1D-CNNR vs. MODIS','Units','Normalized','Position',[0.02 0.10],'FontWeight','bold','Fontname','Times New Roman','Fontsize',34);
...
[STAT16YPHN,R]=geotiffread(['../output/17_TAVG12IND/Cnn12BIAS.',YPHNName,'.2001.2015.tif']);
Class=STAT16YPHN;
...
text('String',['c)',' Bias (',CaptName,')'],'Units','Normalized','Position',[0.02 0.20],'FontWeight','bold','Fontname','Times New Roman','Fontsize',34);
text('String','1D-CNNR vs. MODIS','Units','Normalized','Position',[0.02 0.10],'FontWeight','bold','Fontname','Times New Roman','Fontsize',34);
...
imwrite(Fig,[Path_Figure,'IntraStatsCnn.',YPHNName,'.tif'],'Compression','LZW','Resolution',300);
