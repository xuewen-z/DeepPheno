...
YPHNList = {'SUM','AUT'}; 
CaptList ={'maturation','senescence'}; 
...
ylabel([CaptName,' (day)'],'FontWeight','bold','Fontname','Times New Roman','Fontsize',28);

view([90 -90]);
xtickangle(90);  

Hlegend=legend([H1.mainLine,H2.mainLine],{'MODIS','1D-CNNR'}); legend boxoff;
...
text('String',['r = ',num2str(R1,'%.2f')],'Color',[0.9333,0.1843,0.2078],...
    'Units','Normalized','Position',[0.50 0.14],'FontWeight','bold','Fontname','Times New Roman','Fontsize',28);

% R2   = rvalue(BPHN12AVG,OPHN12AVG);
% text('String',['r = ',num2str(R2,'%.2f')],'Color',[1,0.647,0.478],...
%     'Units','Normalized','Position',[0.05 0.10],'FontWeight','bold','Fontname','Times New Roman','Fontsize',28);
